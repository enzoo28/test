...
VOL_HIST_HOSTS_ENTRY = os.environ.get(
    ...
    "192.168.0.25  depth-it.historical.deepcharts.com",
)
...
BRIDGE_EXE = os.environ.get(
    "BRIDGE_EXE",
    os.path.join(ROOT_DIR, "patched_run", "bridge", "VolumetricaBridge.exe"),
)
BRIDGE_DIR = os.environ.get(
    "BRIDGE_DIR",
    os.path.join(ROOT_DIR, "patched_run", "bridge"),
)
...
DEEPCHART_EXE = os.environ.get(
    "DEEPCHART_EXE",
    os.path.join(ROOT_DIR, "patched_run", "Deepchart.exe"),
)
DEEPCHART_DIR = os.environ.get(
    "DEEPCHART_DIR",
    os.path.join(ROOT_DIR, "patched_run"),
)
...
CA_DIR = os.environ.get("CA_DIR", os.path.join(ROOT_DIR, "mitm_ca"))
